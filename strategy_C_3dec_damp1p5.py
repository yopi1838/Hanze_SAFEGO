# -*- coding: ascii -*-
"""
Strategy C (RATCHETING, 1.5% RAYLEIGH) : Adaptive Sequential IDA
=======================================================================
...
sys.path). Run inside 3DEC:
    ...
    call 'strategy_C_3dec_damp1p5.py'
...
OUT_DIR = "stratC_results_DAMP1p5"
...
DAMP_RATIO = 0.015       # fraction of critical at the centre frequency
