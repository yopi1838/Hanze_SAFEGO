# -*- coding: ascii -*-
"""
Strategy C (RATCHETING) : Adaptive Sequential IDA with asymmetric pulse
=======================================================================
...
sys.path). Run inside 3DEC:
    ...
    call 'strategy_C_3dec_ratcheting.py'
...
OUT_DIR = "stratC_results_RATCHETING"
...
FISH_HISTORIES = {
    ...
    4: "Top_Quarter_A_Disp", 5: "Top_Quarter_B_Disp", 6: "cstav", 7: "ncstav",
    8: "tilt_bot_seg", 9: "tilt_low_seg", 10: "tilt_up_seg",
    11: "tilt_beam_seg", 12: "tilt_full_wall", 13: "rel_disp_top_mm",
}
...
def setup_model_for_dynamic(save_file):
    ...
    """)
    it.command("""
    block mechanical damping rayleigh 0.03 {freq}
