...
# =====================================================================
# STANDALONE CASE: SS_MAXWELL_1p5_SERVO
# =====================================================================
...
#   output     : stratC_results_SS_MAXWELL_SERVO
#
...
# =====================================================================
#   top boundary : SPRING SERVO, F = F0 + k*dy, k = 2 x 49.5 N/mm
#                  (Moshfeghi et al. 2024 sec. 2.2). NOT a
#                  constant-stress servo -- see SERVO_ON.
# =====================================================================
# 1.  PARAMETERS
# =====================================================================
T1_init     = 0.0948
...
OUT_DIR = 'stratC_results_SS_MAXWELL_SERVO'
...
CASE_ID       = 'SS_MAXWELL_1p5_SERVO'           # free-text label echoed into the log
